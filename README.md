# Data Science Academy: Microsoft Power BI para Business Inteligence e Data Science

Este repositório servirá para demonstrar minha evolução enquanto curso as aulas da DSA.  
  
O curso possui 20 módulos e dentre estes, 18 contém laboratórios. Visto que os laboratórios são propostos no inicio de cada módulo, quando possível, irei empregar a metodologia de publicar minhas respostas antes e depois de assistir as aulas relacionadas.  
  
### Progresso:  
1. Introdução:  
    - Assistido  
1. Primeiros Passos Com Power BI:  
    - Publicada a Resposta Pré Video&emsp;&emsp;FEITO  
    - Publicada a Resposta Pós Video&emsp;&emsp;FEITO  
1. Modelagem, Relacionamentos e DAX:  
    - Publicada a Resposta Pré Video&emsp;&emsp;FEITO  
    - Publicada a Resposta Pós Video&emsp;&emsp;FEITO  
1. Power BI Para Análise de Dados de Marketing:  
    - Publicada a Resposta Final&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;FEITO  
1. Power BI Para Análise de Dados Comerciais:  
    - Publicada a Resposta Pré Video&emsp;&emsp;FEITO  
    - Publicada a Resposta Pós Video&emsp;&emsp;FEITO  
1. Power BI Para Análise de Dados de Recursos Humanos:  
    - Publicada a Resposta Pré Video&emsp;&emsp;FEITO  
    - Publicada a Resposta Pós Video&emsp;&emsp;FEITO  
...
* Módulo 01:  
    ...
    - ___Erro__ [Análise de Dados com Microsoft Power BI e Clínica de BI](https://www.datascienceacademy.com.br/course/analise-de-dados-com-microsoft-power-bi-e-clinica-de-bi-dsa)   
    - ___Erro__ [Visualização de Dados e Design de Dashboards](https://www.datascienceacademy.com.br/course/cincia-de-dados-aplicada)  
* Módulo 02:
    - [Site Oficial do Power BI](https://powerbi.microsoft.com/pt-br/)  
    - [Visuais do Power BI](https://appsource.microsoft.com/pt-br/marketplace/apps?product=power-bi-visuals&exp=ubp8)  
    - [Fonte de Dados](https://data.world/)  
* Módulo 03:
    - [Aplicar relações muitos para muitos no Power BI Desktop](https://learn.microsoft.com/pt-br/power-bi/transform-model/desktop-many-to-many-relationships)  
    - [Modelar relações no Power BI Desktop](https://learn.microsoft.com/pt-br/power-bi/transform-model/desktop-relationships-understand)  
* Módulo 04:
    - [10 Marketing KPIs You ShouldBe Tracking](https://www.impactplus.com/blog/the-10-marketing-kpis-you-should-be-tracking)  
    ...
    - [20 Marketing KPIs You Need to Track in 2023](https://clickup.com/blog/marketing-kpis/)  
    - [Dataset usado como base para o dataset deste capítulo:](https://archive.ics.uci.edu/ml/datasets/bank+marketing)  
* Módulo 05:  
